...
open class RCPagerSnapFancyDecorator : RecyclerView.ItemDecoration {
    ...
    private fun isLastItem(index: Int, recyclerView: RecyclerView) = if(recyclerView.adapter == null) false else index == (recyclerView.adapter!!.itemCount - 1)
}